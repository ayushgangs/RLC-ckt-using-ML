...
data=pd.read_csv("C:\\Users\\rajesh\\Desktop\\Resfreq.csv")
...
d=data.drop(['Inductance','Resonance Frequency'],axis=1)
d=d.Capacitance.unique()
d=pd.DataFrame(data=d,columns=["Capacitance"])
w3=float(input("Enter resfreq b/w 3.6e+10 & 2e+11: "))
x1="Inductance"             



n=np.ones(d.size)*w3
d.insert(1, "RF", n, True) 
y=mlpredict(x1,d)
