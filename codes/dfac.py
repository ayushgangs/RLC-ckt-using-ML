...
data=pd.read_csv("C:\\Users\\rajesh\\Desktop\\dfactor.csv")
...
d=data.drop(['Inductance','Damping Factor'],axis=1)

w3=float(input("Enter dfactor b/w 0.003 & 0.09: "))
x1="Inductance"             
